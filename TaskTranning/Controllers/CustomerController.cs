    ...
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> Edit(CustomerViewModel editCustomer)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    TempData["succcessMessage"] = _resourcesServices.GetLocalizedHtmlString("customer_msg_EditCustomerSuccess").ToString();
                    return RedirectToAction("Index");
                }   
            }
            ViewData["errorMessage"] = _resourcesServices.GetLocalizedHtmlString("customer_msg_EditCustomerError");
